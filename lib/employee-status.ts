...
export type EmployeeDayStatus = "off" | "committed" | "transit" | "on_duty";
 ...
 * assignment data — never a guess. Status precedence: OFF (per
 * weekly_shifts) beats everything else; a foreign-company commitment
 * (backed by a real Assignment to a company_config requirement on that
 * day) beats Transit; Transit assignment beats plain "on duty".
 *
